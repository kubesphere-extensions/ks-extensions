  ...
  spec:
    ...
    containers:
      - name: higress-gateway
        image: '{{ default .Values.global.imageRegistry .Values.gateway.image.registry }}/{{ .Values.gateway.image.repository }}:{{ default .Chart.AppVersion .Values.gateway.image.tag }}'
        args:
          - proxy
          - router
          - --domain
