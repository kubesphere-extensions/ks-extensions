{{- define "ray.image" -}}
{{ include "common.images.image" (dict "imageRoot" .Values.server.ray.image "global" .Values.global) }}
{{- end -}}

{{- define "llm.image" -}}
{{ include "common.images.image" (dict "imageRoot" .Values.server.llm.image "global" .Values.global) }}
{{- end -}}
