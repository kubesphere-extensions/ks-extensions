...
{{- define "postInstallJob.image" -}}
{{ include "common.images.image" (dict "imageRoot" .Values.postInstallJob.image "global" .Values.global) }}
{{- end -}}
...
{{- define "postInstallJob.imagePullSecrets" -}}
{{- include "common.images.pullSecrets" (dict "images" (list .Values.postInstallJob.image) "global" .Values.global) -}}
{{- end -}}
